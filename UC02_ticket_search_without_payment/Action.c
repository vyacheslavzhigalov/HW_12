...
/*Correlation comment - Do not change!  Original value='139102.745889024HVffAQHptQVzzzzHtcQDApfitQf' Name ='userSession' Type ='ResponseBased'*/
	...
	lr_end_transaction("UC02_ticket_search_without_payment",LR_AUTO);
