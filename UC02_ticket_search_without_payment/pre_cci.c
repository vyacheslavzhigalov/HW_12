# 1 "c:\\xsetcourse\\loadrunner\\hw_12\\uc02_ticket_search_without_payment\\\\combined_UC02_ticket_search_without_payment.c"
...
# 1 "c:\\xsetcourse\\loadrunner\\hw_12\\uc02_ticket_search_without_payment\\\\combined_UC02_ticket_search_without_payment.c" 2
...
# 2 "c:\\xsetcourse\\loadrunner\\hw_12\\uc02_ticket_search_without_payment\\\\combined_UC02_ticket_search_without_payment.c" 2
...
char WebSocketReceive0[] = "{\"messageType\":\"hello\",\"uaid\":\"eb60c4f61882448b89e370c5606aab32\",\"statu"
...
# 3 "c:\\xsetcourse\\loadrunner\\hw_12\\uc02_ticket_search_without_payment\\\\combined_UC02_ticket_search_without_payment.c" 2
...
# 4 "c:\\xsetcourse\\loadrunner\\hw_12\\uc02_ticket_search_without_payment\\\\combined_UC02_ticket_search_without_payment.c" 2

# 1 "Action.c" 1
Action()
{
	lr_start_transaction("UC02_ticket_search_without_payment");
	...
	(web_remove_auto_header("Sec-GPC", "ImplicitGen=Yes", "LAST"));
	...
	lr_end_transaction("ticket_search",2);
	...
	web_reg_save_param("Flight departing from \"{depart}\"",
		"LB/IC=",
		"RB/IC=",
		"NotFound=ERROR",
		"LAST");
	...
	lr_end_transaction("date_input",2);

	lr_think_time(22);

	lr_start_transaction("time_input");
	
	web_reg_save_param("Thank you",
		"LB=",
		"RB=",
		"NotFound=ERROR",
		"LAST");
	...
	lr_end_transaction("time_input",2);
	...
	lr_end_transaction("UC02_ticket_search_without_payment",2);

	return 0;
}
# 5 "c:\\xsetcourse\\loadrunner\\hw_12\\uc02_ticket_search_without_payment\\\\combined_UC02_ticket_search_without_payment.c" 2
...
# 6 "c:\\xsetcourse\\loadrunner\\hw_12\\uc02_ticket_search_without_payment\\\\combined_UC02_ticket_search_without_payment.c" 2
